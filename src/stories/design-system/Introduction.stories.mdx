...
## Figma Tokens Plugin
The [Figma Tokens Plugin](https://www.figma.com/community/plugin/843461159747178978/Figma-Tokens) should be installed by designers and developers, as it is needed for modifying, and inspecting tokens.

Design tokens are pushed to the repo via the Figma Tokens Plugin to ```src/theming/tokens-figma/tokens.json``` (set this as the 'File Path' in the Figma Tokens Plugin).
